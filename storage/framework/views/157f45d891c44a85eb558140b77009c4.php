                ...
                <tbody>
                    <?php $__currentLoopData = $produks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="<?php echo e(route('produk.edit', ['produk' => $produk->id])); ?>" class="btn btn-xs text-success p-0 mr-1">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button type="button" data-toggle="modal" data-target="#modalDelete"
                                    data-url="<?php echo e(route('produk.destroy', ['produk' => $produk->id])); ?>"
...
<?php echo $__env->make('layouts.main', ['title' => 'Produk'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\kasir-toko-riska\resources\views/produk/index.blade.php ENDPATH**/ ?>