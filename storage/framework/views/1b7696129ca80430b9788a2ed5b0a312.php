                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <button type="button" data-toggle="modal" data-target="#modalDelete"
                                    data-url="<?php echo e(route('stok.destroy', ['stok' => $stok->id])); ?>"
...
<?php echo $__env->make('layouts.main', ['title' => 'Stok'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\latihan-ujikom\jk\kasir-toko-riska\resources\views/stok/index.blade.php ENDPATH**/ ?>